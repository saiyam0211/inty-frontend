...
const LogoGrid = () => {
    return (
            <>
            <div>
            <Marquee direction="left" gradient={false} speed={120} className="flex justify-center gap-8">
           ...
           <Marquee direction="right" gradient={false} speed={120} className="flex justify-between gap-4">
           ...
           <Marquee direction="left" gradient={false} speed={120} className="flex justify-center gap-4">
            <img src={Banner1} alt="Logo 1" className="w-16 h-16 ml-40" />
            <img src={Banner2} alt="Logo 2" className="w-16 h-16 ml-40" />
            <img src={Banner3} alt="Logo 3" className="w-16 h-16 ml-40" />
            <img src={Banner4} alt="Logo 4" className="w-16 h-16 ml-40" />
