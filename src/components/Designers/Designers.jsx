...
const images = [
  ...
  { src: "/images/desiger2.png", logo: "/images/designer-logo1.png" },
  { src: "/images/desiger3.png", logo: "/images/designer-logo1.png" },
  { src: "/images/desiger4.png", logo: "/images/designer-logo1.png" },
  { src: "/images/desiger5.png", logo: "/images/designer-logo1.png" },
  { src: "/images/desiger6.png", logo: "/images/designer-logo1.png" },
];
const Designers = () => {
  return (
      ...
      {images.map((img, index) => (
        <div key={index} className="relative group overflow-hidden w-64 h-96">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white/80 py-4 flex justify-center items-center transition-all duration-500 group-hover:bottom-1/2">
            <img src={img.logo} alt="Logo" className="w-16 h-16 transition-all duration-500" />
          </div>
        </div>
      ))}
    </div>
