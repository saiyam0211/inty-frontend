...
//         <div key={rowIndex} className={`grid grid-cols-4 gap-[19px] ${rowIndex === 0 ? '' : 'border-t border-gray-400'}`}> 
//           <div className="bg-white font-bold flex items-center justify-center">
//             {row.label}
//           </div>
//           {data.map((item, idx) => (
//             <div 
...
//               {row.key ? (
//                 row.key === "chair" ? (
//                   <img src={item[row.key]} alt="Chair" className="w-[308px] h-[334px]" />
//                 ) : (
//                   item[row.key]
//                 )
//               ) : (
