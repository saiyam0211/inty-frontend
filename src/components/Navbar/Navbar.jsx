  ...
  return (
    <nav className="flex justify-between items-center w-[89%] m-auto py-4">
      ...
      <ul className="hidden md:flex gap-10 text-lg font-medium">
       <a href="/"><li className="cursor-pointer hover:text-[#006452]">Home</li></a>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 left-0 w-full z-50 h-full bg-white flex flex-col items-center justify-center gap-6 text-lg font-medium transition-transform ${
