  ...
  return (
    <div className="w-[294px] h-[392px]  bg-white shadow-2xl rounded-[8px]">
      ...
      <div className="flex justify-between p-4">
        ...
        <a href="./compare"><button className="button cursor-pointer w-[96px] h-[31px] bg-[rgba(0,100,82,0.4)] text-white rounded-[8px] mt-[18px] hover:bg-[#006452]">
          Compare
        </button>
        </a>
      </div>
      ...
      <div className="bg-[#006452]  text-white w-full p-4 rounded-[16px] mt-3 hover:bg-[#006452] transition duration-300 flex flex-col gap-4">
        <div className="flex justify-between">
          ...
          <button className="bg-[rgba(254,97,0,1)] text-sm h-5 w-25  text-white rounded-[8px]">
            USP
          </button>
        </div>
      ...
      <a href="./CompanyProfile">  <button className="mt-1 p-2 cursor-pointer bg-white w-full rounded-4xl text-blue-500">
          Know More
        </button>
        </a>
      </div>
