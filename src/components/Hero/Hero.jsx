...
const Hero = () => {
  ...
  >
    ...
    <div className="max-w-xl text-white text-center lg:text-left lg:ml-16"  data-aos="fade-up">
      ...
      <button className="mt-6 px-6 py-2 bg-[#006452] text-white sm:py-5 text-2xl rounded-lg shadow-md md:text-2xl md:py-5 hover:bg-[#006452] transition duration-300">
        Explore Services
      </button>
    </div>
