...
//         <button
//           className="absolute left-0 text-white bg-zinc-600 bg-opacity-50  rounded-full"
//           onClick={prevImage}
//         >
//           <FaChevronLeft size={20} />  {/* Left Arrow */}
//         </button>
//         <img
...
//         />
//         <button
//           className="absolute right-0 text-white bg-zinc-600 bg-opacity-50 px-0.2 rounded-full"
//           onClick={nextImage}
//         >
//           <FaChevronRight size={20} />  {/* Right Arrow */}
//         </button>
...
//               className={`w-2 h-2 mx-1 rounded-full cursor-pointer ${currentIndex === index ? 'bg-black' : 'bg-gray-400'}`}
//             ></div>
//           ))}
//         </div>
//       </div>
...
const TableCarousel = () => {
  const images = [chair, chair, chair];
  const [currentIndex, setCurrentIndex] = useState(0);
